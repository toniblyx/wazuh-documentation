...
|                                   |                                                                                                                                   |
|                                   | A local file will be added to the :doc:`ossec.conf <../configuration/ossec-conf/index>`                                           |
+-----------------------------------+-----------------------------------------------------------------------------------------------------------------------------------+
| **addsite <domain>**              | Monitor a website for changes.                                                                                                    |
|                                   |                                                                                                                                   |
|                                   | A ``full_command`` will be added to the :doc:`ossec.conf <../configuration/ossec-conf/index>` using lynx to dump the initial page.|
|                                   |                                                                                                                                   |
...
|                                   |                                                                                                                                   |
|                                   | A ``full_command`` will be added to the :doc:`ossec.conf <../configuration/ossec-conf/index>` using the host command.             |
+-----------------------------------+-----------------------------------------------------------------------------------------------------------------------------------+

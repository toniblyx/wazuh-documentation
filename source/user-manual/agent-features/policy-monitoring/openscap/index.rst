...
+----------+---------+------------------------+----------------+------------+-------------------------+
| RedHat   | 6       | ssg-rhel-6-ds.xml      | Server         |  Y         | N                       |
+----------+---------+------------------------+----------------+------------+-------------------------+
| RedHat   | 6       | cve-redhat-6-ds.xml    | N/A            |  N         | Y                       |
+----------+---------+------------------------+----------------+------------+-------------------------+
...
+----------+---------+------------------------+----------------+------------+-------------------------+
| Ubuntu   | trusty  | cve-debian-oval.xml    | N/A            |  N         | Y                       |
+----------+---------+------------------------+----------------+------------+-------------------------+
| Ubuntu   | precise | cve-debian-oval.xml    | N/A            |  N         | Y                       |
+----------+---------+------------------------+----------------+------------+-------------------------+
